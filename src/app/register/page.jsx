            ...
            <form onSubmit={handleRegister} className="flex flex-col">
              ...
              <div className="mb-3">
                ...
                <div
                  ...
                  className="show-password absolute right-[37px] bottom-[131px]"
                >
                  {showPassword ? (
                    <svg
                      stroke="currentColor"
...
{
  /* 
                <div className="flex bg-[#212121] focus:outline-none placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg w-full p-2.5">
                  <input
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                    name="subject"
                    ...
                    id="subject"
                    required
                    className="bg-[#212121] focus:outline-none placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full"
                    placeholder="Enter your password"
                  />
                  <div
                    onClick={() => setShowPassword(!showPassword)}
